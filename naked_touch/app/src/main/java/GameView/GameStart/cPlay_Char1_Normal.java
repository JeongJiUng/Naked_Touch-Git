 ...
 */
public class cPlay_Char1_Normal implements cGameState
{
    final int               PLAY = 0;
    final int               CLEAR = 1;
    final int               FAIL = 2;
    ...
    public void init()
    {
        ...
        action              = new cTouchAction(cGameManager.getInstance().getBitmap(R.drawable.char01_nude_normal), 4);
        action.setPartsLocation(0, "팬티", cGameManager.getInstance().getBitmap(R.drawable.char01_pants_normal), 211, 660, 10);
        action.setPartsLocation(1, "브레지어", cGameManager.getInstance().getBitmap(R.drawable.char01_bra_normal), 109, 316, 10);
        action.setPartsLocation(2, "하의", cGameManager.getInstance().getBitmap(R.drawable.char01_bot_normal), 214, 653, 10);
        action.setPartsLocation(3, "상의", cGameManager.getInstance().getBitmap(R.drawable.char01_top_normal), 103, 339, 10);
    }
    ...
    private boolean clear()
    {
        ...
        if (action.getClearEnable() == true)
        {
            ...
            cUserData.getInstance().setClearStage(CHARACTER_LIST.TEMP_CHAR1.getCharacter(), 0, true);
