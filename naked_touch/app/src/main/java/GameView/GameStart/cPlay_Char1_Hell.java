...
/**
 * Created by AVG on 2016-05-31.
 */
public class cPlay_Char1_Hell implements cGameState
{
    final int               PLAY = 0;
    final int               CLEAR = 1;
    final int               FAIL = 2;
    ...
    public void init()
    {
        ...
        action              = new cTouchAction(cGameManager.getInstance().getBitmap(R.drawable.char01_nude_hell), 4);
        action.setPartsLocation(0, "팬티", cGameManager.getInstance().getBitmap(R.drawable.char01_pants_hell), 266, 724, 10);
        action.setPartsLocation(1, "브레지어", cGameManager.getInstance().getBitmap(R.drawable.char01_bra_hell), 192, 444, 10);
        action.setPartsLocation(2, "하의", cGameManager.getInstance().getBitmap(R.drawable.char01_bot_hell), 215, 356, 10);
        action.setPartsLocation(3, "상의", cGameManager.getInstance().getBitmap(R.drawable.char01_top_hell), 191, 420, 10);
    }
    ...
    private boolean clear()
    {
        ...
        if (action.getClearEnable() == true)
        {
            ...
            cUserData.getInstance().setClearStage(CHARACTER_LIST.TEMP_CHAR1.getCharacter(), 2, true);
